...
module.exports = {
  getAllCards: (req, res) => {
    ...
    res.status(200).json(static.allCardInfo)
  },
  apply: (req, res) => {
    ...
    if (!Object.keys(static.allCardInfo).includes(cardAppliedForId)) {
    ...
    const cardAppliedFor = static.allCardInfo[cardAppliedForId]
